...
CFLAGS_windows = -Wall -Wextra -Wno-unused-parameter
LIBFLAG_windows = -O -Wl,-s -static-libgcc -lole32 -lcomctl32 -loleaut32 -luuid -mwindows
TARGET_windows = $(LIBNAME).dll

CFLAGS_linux = -fPIC -pedantic  -Wall -Wextra -Wno-unused-parameter \
...
CFLAGS   += -Icore/include $(LUA_CFLAGS) $(CFLAGS_$(PLAT))
